...
<?php if ($id || $new) : ?>
		<form method="post" action="?p=interventi">
			...
			<a href="?p=interventi&del=<?=$id['id']?>" tabindex="-1">
				Elimina
			</a>
                    </div>
		</form>
<?php else : ?>
	<div class="tablecontainer">
            <table style="table-layout:fixed" class="tablecontainer table-bordered">
			<colgroup>
...
<?php endif; ?>
<button class="btn btn-success"><a href="?p=interventi&create=1">Inserisci nuovo</a></button>
<script>
	var chg=function(e){
